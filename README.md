...
To build the final jar and optimize the MatchingAccelerator application for production, run:
...
Then navigate to [http://localhost:5010](http://localhost:5010) in your browser.
